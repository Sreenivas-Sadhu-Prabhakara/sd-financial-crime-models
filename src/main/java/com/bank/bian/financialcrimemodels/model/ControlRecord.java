package com.bank.bian.financialcrimemodels.model;
...
/**
 * The BIAN control record for this service domain: "Financial Crime Model Development Project".
 *
 ...
 * to its asset type (Financial Crime Model). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Financial Crime Model Development Project";
